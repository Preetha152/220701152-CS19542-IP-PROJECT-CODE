...
$mail->Username = "220701152@rajalakshmi.edu.in";                 // SMTP username
$mail->Password = 'Preetha@2005';                           // SMTP password
$mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
$mail->Port = 587;                                    // TCP port to connect to

$mail->setFrom("220701152@rajalakshmi.edu.in", 'Maadhu Preetha');
$mail->addAddress($email);     // Add a recipient

$mail->addReplyTo('220701152@rajalakshmi.edu.in');
