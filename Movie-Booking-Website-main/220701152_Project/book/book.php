    ...
    <h2 class="booking-title">Movie Booking</h2>
        <div class="booking-details">
            ...
            <br><div class="options">Select the Date : 
                <div class="the-option" onclick="datetimeselect('augone')" id="augone">October 8th<input type="checkbox" class="augone" hidden value="aug1" name="date"></div>
            <div class="the-option" onclick="datetimeselect('augtwo')" id="augtwo">October 9th<input type="checkbox" class="augtwo" hidden value="aug2" name="date"></div>
            <div class="the-option" onclick="datetimeselect('augthree')" id="augthree">October 10th<input type="checkbox" class="augthree" hidden value="aug3" name="date"></div><br></div>
