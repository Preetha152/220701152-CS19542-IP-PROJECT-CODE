    ...
    <main class="home-page">
        <div class="image-slider">
            ...
            <div class="photo" id="photo1">
                <img src="../img/slider/pic2.jpg" alt="image" width="2000" height="650">
                <h3 class="text1">"DreamWorld Cinemas is one of the best theatres in India that provides customer-focused cinema experience."</h3>
            </div>
            <div class="photo" id="photo2">
                <img src="../img/slider/pic1.jpg" alt="image" width="2000" height="650">
                <h3 class="text1">"DreamWorld Cinemas draws you into something as close to reality as you have ever experienced" </h3>
            </div>
            <div class="photo" id="photo3">
                <img src="../img/slider/pic3.jpg" alt="image" width="2000" height="650">
